    ...
    <div className="max-w-sm md:max-w-4xl mx-auto antialiased font-sans px-4 md:px-8 lg:px-12 py-20">
      <div className="relative grid grid-cols-1 md:grid-cols-2  gap-20">
        ...
        <div className="flex justify-between flex-col py-4">
          ...
          >
            <h3 className="text-2xl font-bold !text-white text-black">
              {testimonials[active].name}
            </h3>
            <p className="text-sm text-gray-500 !text-neutral-500">
              {testimonials[active].designation}
            </p>
            <motion.p className="text-lg text-gray-500 mt-8 !text-neutral-300">
          ...
          <div className="flex gap-4 pt-12 md:pt-0">
            <button
              onClick={handlePrev}
              className="h-7 w-7 rounded-full bg-gray-100 !bg-neutral-800 flex items-center justify-center group/button"
            >
